...
def plot_percentage(numerators, denominator):
    ...
    c1 = ROOT.TCanvas( 'c1', 'Percentage Gain', 200, 10, 700, 500 )
    c1.SetGrid()
    ...
    gr.Draw( 'CP' )
    gr2.GetYaxis().SetRangeUser(0.75,1.20)
...
def plot_rate_plus(n1, n2):
    ...
    c2.Print("rate_pt_update_kl1.png")
...
def plot_rate(n1, n2):
    ...
    x2 = [ 53.3405, 57.3348, 58.9265, 67.6334, 81.2624, 83.6999]


    x3 = [ 26.7306, 27.0895, 27.9940, 33.5199, 38.4038, 40.3331]
    ...
    gr2 = ROOT.TGraph(6, x, y)
    gr2.SetMarkerSize(1.5)
    gr2.SetMarkerColor( 2 )
    gr2.SetMarkerStyle( 23 )
    gr2.GetYaxis().SetTitle( 'Rate [Hz]' )
    gr2.GetXaxis().SetTitle( 'Signal Efficiency')
    gr2.GetYaxis().SetRangeUser(10, 95)
    gr2.Draw("AP")

    gr1 = ROOT.TGraph(6, xx, y1)
    ...
    # gr.SetTitle( 'a simple graph' )
    # gr.Draw( 'CP' )
    gr2.GetXaxis().SetLimits(0.65, 0.78)
    gr1.GetXaxis().SetRangeUser(0.5, 1)


    
    posleg("L","U",2)
    legend = ROOT.TLegend(0.2, 0.8, 0.45, 0.95)
    legend.SetTextSize(0.035)
    legend.SetBorderSize(0)
    legend.SetHeader("kl=1")
    # legend.AddEntry(gr, "25 GeV")
    legend.AddEntry(gr2,"L1DR-TAU20ITAU12I-J25")
    legend.AddEntry(gr1,"L1TAU20IM_2TAU12IM_4J12p0ETA25")
    legend.Draw("same")

    c1.Update()

    c1.Print("rate_pt.png")
...
def test():
    ...
    # plot_percentage(n1, numerators[9])
