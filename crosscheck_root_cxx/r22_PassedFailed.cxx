...
TH1F* TrigMatched_Taus_HLTptfl_Pt_PF()
{
//=========Macro generated from canvas: tcanvas1/tcanvas1
//=========  (Mon May 23 03:57:44 2022) by ROOT version 6.26/02
   TCanvas *tcanvas1 = new TCanvas("tcanvas1", "tcanvas1",1,1,4,4);
   tcanvas1->Range(0,0,1,1);
   tcanvas1->SetBorderMode(0);
   tcanvas1->SetBorderSize(0);
   ...
   TH1F *PtoPcP__1 = new TH1F("PtoPcP__1","TrigMatched_Taus_HLTptfl.Pt()",100,0,1020);
   PtoPcP__1->SetBinContent(3,2010);
   PtoPcP__1->SetBinContent(4,4111);
   PtoPcP__1->SetBinContent(5,3601);
   PtoPcP__1->SetBinContent(6,3025);
   PtoPcP__1->SetBinContent(7,2586);
   PtoPcP__1->SetBinContent(8,2073);
   PtoPcP__1->SetBinContent(9,1716);
   PtoPcP__1->SetBinContent(10,1562);
   PtoPcP__1->SetBinContent(11,1267);
   PtoPcP__1->SetBinContent(12,1187);
   PtoPcP__1->SetBinContent(13,1031);
   PtoPcP__1->SetBinContent(14,967);
   PtoPcP__1->SetBinContent(15,840);
   PtoPcP__1->SetBinContent(16,767);
   PtoPcP__1->SetBinContent(17,627);
   PtoPcP__1->SetBinContent(18,552);
   PtoPcP__1->SetBinContent(19,459);
   PtoPcP__1->SetBinContent(20,362);
   PtoPcP__1->SetBinContent(21,337);
   PtoPcP__1->SetBinContent(22,268);
   PtoPcP__1->SetBinContent(23,234);
   PtoPcP__1->SetBinContent(24,210);
   PtoPcP__1->SetBinContent(25,159);
   PtoPcP__1->SetBinContent(26,139);
   PtoPcP__1->SetBinContent(27,136);
   PtoPcP__1->SetBinContent(28,93);
   PtoPcP__1->SetBinContent(29,86);
   PtoPcP__1->SetBinContent(30,78);
   PtoPcP__1->SetBinContent(31,58);
   PtoPcP__1->SetBinContent(32,55);
   PtoPcP__1->SetBinContent(33,59);
   PtoPcP__1->SetBinContent(34,44);
   PtoPcP__1->SetBinContent(35,44);
   PtoPcP__1->SetBinContent(36,40);
   PtoPcP__1->SetBinContent(37,21);
   PtoPcP__1->SetBinContent(38,17);
   PtoPcP__1->SetBinContent(39,25);
   PtoPcP__1->SetBinContent(40,16);
   PtoPcP__1->SetBinContent(41,11);
   PtoPcP__1->SetBinContent(42,13);
   PtoPcP__1->SetBinContent(43,11);
   PtoPcP__1->SetBinContent(44,6);
   PtoPcP__1->SetBinContent(45,3);
   PtoPcP__1->SetBinContent(46,5);
   PtoPcP__1->SetBinContent(47,3);
   PtoPcP__1->SetBinContent(48,3);
   PtoPcP__1->SetBinContent(49,4);
   PtoPcP__1->SetBinContent(50,1);
   PtoPcP__1->SetBinContent(51,1);
   PtoPcP__1->SetBinContent(52,2);
   PtoPcP__1->SetBinContent(53,2);
   PtoPcP__1->SetBinContent(54,1);
   PtoPcP__1->SetBinContent(57,1);
   PtoPcP__1->SetBinContent(58,1);
   PtoPcP__1->SetBinContent(62,1);
   PtoPcP__1->SetBinContent(64,1);
   PtoPcP__1->SetBinContent(65,1);
   PtoPcP__1->SetBinContent(66,1);
   PtoPcP__1->SetBinContent(71,1);
   PtoPcP__1->SetBinContent(75,1);
   PtoPcP__1->SetBinContent(77,1);
   PtoPcP__1->SetBinContent(90,1);
   PtoPcP__1->SetBinContent(92,1);
   PtoPcP__1->SetEntries(30939);
   PtoPcP__1->SetDirectory(0);
...
TH1F* TrigMatched_Taus_HLTptfl_Eta_PF()
{
//=========Macro generated from canvas: tcanvas1/tcanvas1
//=========  (Mon May 23 03:59:28 2022) by ROOT version 6.26/02
   TCanvas *tcanvas1 = new TCanvas("tcanvas1", "tcanvas1",0,0,4,28);
   tcanvas1->Range(0,0,1,1);
   tcanvas1->SetBorderMode(0);
   tcanvas1->SetBorderSize(0);
   ...
   TH1F *EtaoPcP__2 = new TH1F("EtaoPcP__2","TrigMatched_Taus_HLTptfl.Eta()",100,-3.3,3.3);
   EtaoPcP__2->SetBinContent(9,1);
   EtaoPcP__2->SetBinContent(10,1);
   EtaoPcP__2->SetBinContent(11,8);
   EtaoPcP__2->SetBinContent(12,61);
   EtaoPcP__2->SetBinContent(13,98);
   EtaoPcP__2->SetBinContent(14,122);
   EtaoPcP__2->SetBinContent(15,115);
   EtaoPcP__2->SetBinContent(16,159);
   EtaoPcP__2->SetBinContent(17,156);
   EtaoPcP__2->SetBinContent(18,181);
   EtaoPcP__2->SetBinContent(19,200);
   EtaoPcP__2->SetBinContent(20,203);
   EtaoPcP__2->SetBinContent(21,220);
   EtaoPcP__2->SetBinContent(22,227);
   EtaoPcP__2->SetBinContent(23,262);
   EtaoPcP__2->SetBinContent(24,269);
   EtaoPcP__2->SetBinContent(25,255);
   EtaoPcP__2->SetBinContent(26,270);
   EtaoPcP__2->SetBinContent(27,242);
   EtaoPcP__2->SetBinContent(28,269);
   EtaoPcP__2->SetBinContent(29,345);
   EtaoPcP__2->SetBinContent(30,331);
   EtaoPcP__2->SetBinContent(31,400);
   EtaoPcP__2->SetBinContent(32,368);
   EtaoPcP__2->SetBinContent(33,371);
   EtaoPcP__2->SetBinContent(34,441);
   EtaoPcP__2->SetBinContent(35,396);
   EtaoPcP__2->SetBinContent(36,468);
   EtaoPcP__2->SetBinContent(37,487);
   EtaoPcP__2->SetBinContent(38,505);
   EtaoPcP__2->SetBinContent(39,582);
   EtaoPcP__2->SetBinContent(40,575);
   EtaoPcP__2->SetBinContent(41,557);
   EtaoPcP__2->SetBinContent(42,656);
   EtaoPcP__2->SetBinContent(43,679);
   EtaoPcP__2->SetBinContent(44,666);
   EtaoPcP__2->SetBinContent(45,703);
   EtaoPcP__2->SetBinContent(46,679);
   EtaoPcP__2->SetBinContent(47,708);
   EtaoPcP__2->SetBinContent(48,765);
   EtaoPcP__2->SetBinContent(49,751);
   EtaoPcP__2->SetBinContent(50,755);
   EtaoPcP__2->SetBinContent(51,717);
   EtaoPcP__2->SetBinContent(52,724);
   EtaoPcP__2->SetBinContent(53,764);
   EtaoPcP__2->SetBinContent(54,682);
   EtaoPcP__2->SetBinContent(55,669);
   EtaoPcP__2->SetBinContent(56,693);
   EtaoPcP__2->SetBinContent(57,694);
   EtaoPcP__2->SetBinContent(58,672);
   EtaoPcP__2->SetBinContent(59,661);
   EtaoPcP__2->SetBinContent(60,581);
   EtaoPcP__2->SetBinContent(61,581);
   EtaoPcP__2->SetBinContent(62,546);
   EtaoPcP__2->SetBinContent(63,499);
   EtaoPcP__2->SetBinContent(64,509);
   EtaoPcP__2->SetBinContent(65,438);
   EtaoPcP__2->SetBinContent(66,409);
   EtaoPcP__2->SetBinContent(67,432);
   EtaoPcP__2->SetBinContent(68,416);
   EtaoPcP__2->SetBinContent(69,418);
   EtaoPcP__2->SetBinContent(70,395);
   EtaoPcP__2->SetBinContent(71,331);
   EtaoPcP__2->SetBinContent(72,316);
   EtaoPcP__2->SetBinContent(73,251);
   EtaoPcP__2->SetBinContent(74,273);
   EtaoPcP__2->SetBinContent(75,251);
   EtaoPcP__2->SetBinContent(76,269);
   EtaoPcP__2->SetBinContent(77,275);
   EtaoPcP__2->SetBinContent(78,234);
   EtaoPcP__2->SetBinContent(79,230);
   EtaoPcP__2->SetBinContent(80,223);
   EtaoPcP__2->SetBinContent(81,208);
   EtaoPcP__2->SetBinContent(82,179);
   EtaoPcP__2->SetBinContent(83,172);
   EtaoPcP__2->SetBinContent(84,145);
   EtaoPcP__2->SetBinContent(85,161);
   EtaoPcP__2->SetBinContent(86,131);
   EtaoPcP__2->SetBinContent(87,122);
   EtaoPcP__2->SetBinContent(88,104);
   EtaoPcP__2->SetBinContent(89,50);
   EtaoPcP__2->SetBinContent(90,6);
   EtaoPcP__2->SetBinContent(92,1);
   EtaoPcP__2->SetEntries(30939);
   EtaoPcP__2->SetDirectory(0);
...
TH1F* TrigMatched_Taus_HLTptfl_Phi_PF()
{
//=========Macro generated from canvas: tcanvas1/tcanvas1
//=========  (Mon May 23 04:00:29 2022) by ROOT version 6.26/02
   TCanvas *tcanvas1 = new TCanvas("tcanvas1", "tcanvas1",0,0,4,28);
   tcanvas1->Range(0,0,1,1);
   tcanvas1->SetBorderMode(0);
   tcanvas1->SetBorderSize(0);
   ...
   TH1F *PhioPcP__3 = new TH1F("PhioPcP__3","TrigMatched_Taus_HLTptfl.Phi()",100,-3.7,3.7);
   PhioPcP__3->SetBinContent(8,140);
   PhioPcP__3->SetBinContent(9,377);
   PhioPcP__3->SetBinContent(10,418);
   PhioPcP__3->SetBinContent(11,351);
   PhioPcP__3->SetBinContent(12,321);
   PhioPcP__3->SetBinContent(13,356);
   PhioPcP__3->SetBinContent(14,388);
   PhioPcP__3->SetBinContent(15,378);
   PhioPcP__3->SetBinContent(16,351);
   PhioPcP__3->SetBinContent(17,377);
   PhioPcP__3->SetBinContent(18,375);
   PhioPcP__3->SetBinContent(19,358);
   PhioPcP__3->SetBinContent(20,368);
   PhioPcP__3->SetBinContent(21,387);
   PhioPcP__3->SetBinContent(22,379);
   PhioPcP__3->SetBinContent(23,394);
   PhioPcP__3->SetBinContent(24,327);
   PhioPcP__3->SetBinContent(25,378);
   PhioPcP__3->SetBinContent(26,403);
   PhioPcP__3->SetBinContent(27,343);
   PhioPcP__3->SetBinContent(28,329);
   PhioPcP__3->SetBinContent(29,347);
   PhioPcP__3->SetBinContent(30,373);
   PhioPcP__3->SetBinContent(31,371);
   PhioPcP__3->SetBinContent(32,332);
   PhioPcP__3->SetBinContent(33,392);
   PhioPcP__3->SetBinContent(34,346);
   PhioPcP__3->SetBinContent(35,374);
   PhioPcP__3->SetBinContent(36,369);
   PhioPcP__3->SetBinContent(37,356);
   PhioPcP__3->SetBinContent(38,377);
   PhioPcP__3->SetBinContent(39,351);
   PhioPcP__3->SetBinContent(40,345);
   PhioPcP__3->SetBinContent(41,402);
   PhioPcP__3->SetBinContent(42,366);
   PhioPcP__3->SetBinContent(43,373);
   PhioPcP__3->SetBinContent(44,365);
   PhioPcP__3->SetBinContent(45,362);
   PhioPcP__3->SetBinContent(46,357);
   PhioPcP__3->SetBinContent(47,366);
   PhioPcP__3->SetBinContent(48,329);
   PhioPcP__3->SetBinContent(49,353);
   PhioPcP__3->SetBinContent(50,369);
   PhioPcP__3->SetBinContent(51,321);
   PhioPcP__3->SetBinContent(52,366);
   PhioPcP__3->SetBinContent(53,373);
   PhioPcP__3->SetBinContent(54,367);
   PhioPcP__3->SetBinContent(55,370);
   PhioPcP__3->SetBinContent(56,362);
   PhioPcP__3->SetBinContent(57,334);
   PhioPcP__3->SetBinContent(58,389);
   PhioPcP__3->SetBinContent(59,387);
   PhioPcP__3->SetBinContent(60,370);
   PhioPcP__3->SetBinContent(61,370);
   PhioPcP__3->SetBinContent(62,343);
   PhioPcP__3->SetBinContent(63,362);
   PhioPcP__3->SetBinContent(64,383);
   PhioPcP__3->SetBinContent(65,354);
   PhioPcP__3->SetBinContent(66,379);
   PhioPcP__3->SetBinContent(67,381);
   PhioPcP__3->SetBinContent(68,381);
   PhioPcP__3->SetBinContent(69,352);
   PhioPcP__3->SetBinContent(70,357);
   PhioPcP__3->SetBinContent(71,380);
   PhioPcP__3->SetBinContent(72,393);
   PhioPcP__3->SetBinContent(73,367);
   PhioPcP__3->SetBinContent(74,378);
   PhioPcP__3->SetBinContent(75,366);
   PhioPcP__3->SetBinContent(76,356);
   PhioPcP__3->SetBinContent(77,337);
   PhioPcP__3->SetBinContent(78,364);
   PhioPcP__3->SetBinContent(79,351);
   PhioPcP__3->SetBinContent(80,375);
   PhioPcP__3->SetBinContent(81,386);
   PhioPcP__3->SetBinContent(82,352);
   PhioPcP__3->SetBinContent(83,381);
   PhioPcP__3->SetBinContent(84,382);
   PhioPcP__3->SetBinContent(85,381);
   PhioPcP__3->SetBinContent(86,344);
   PhioPcP__3->SetBinContent(87,353);
   PhioPcP__3->SetBinContent(88,333);
   PhioPcP__3->SetBinContent(89,349);
   PhioPcP__3->SetBinContent(90,345);
   PhioPcP__3->SetBinContent(91,363);
   PhioPcP__3->SetBinContent(92,380);
   PhioPcP__3->SetBinContent(93,149);
   PhioPcP__3->SetEntries(30939);
   PhioPcP__3->SetDirectory(0);
...
TH1F* TrigMatched_prong_HLTptfl_PF()
{
//=========Macro generated from canvas: tcanvas1/tcanvas1
//=========  (Mon May 23 04:01:23 2022) by ROOT version 6.26/02
   TCanvas *tcanvas1 = new TCanvas("tcanvas1", "tcanvas1",0,0,4,28);
   tcanvas1->Range(0,0,1,1);
   tcanvas1->SetBorderMode(0);
   tcanvas1->SetBorderSize(0);
   ...
   TH1F *TrigMatched_prong_HLTptfl__4 = new TH1F("TrigMatched_prong_HLTptfl__4","TrigMatched_prong_HLTptfl.TrigMatched_prong_HLTptfl",28,0,28);
   TrigMatched_prong_HLTptfl__4->SetBinContent(1,552);
   TrigMatched_prong_HLTptfl__4->SetBinContent(2,11138);
   TrigMatched_prong_HLTptfl__4->SetBinContent(3,3992);
   TrigMatched_prong_HLTptfl__4->SetBinContent(4,5097);
   TrigMatched_prong_HLTptfl__4->SetBinContent(5,2599);
   TrigMatched_prong_HLTptfl__4->SetBinContent(6,2061);
   TrigMatched_prong_HLTptfl__4->SetBinContent(7,1594);
   TrigMatched_prong_HLTptfl__4->SetBinContent(8,1200);
   TrigMatched_prong_HLTptfl__4->SetBinContent(9,889);
   TrigMatched_prong_HLTptfl__4->SetBinContent(10,603);
   TrigMatched_prong_HLTptfl__4->SetBinContent(11,383);
   TrigMatched_prong_HLTptfl__4->SetBinContent(12,294);
   TrigMatched_prong_HLTptfl__4->SetBinContent(13,173);
   TrigMatched_prong_HLTptfl__4->SetBinContent(14,132);
   TrigMatched_prong_HLTptfl__4->SetBinContent(15,79);
   TrigMatched_prong_HLTptfl__4->SetBinContent(16,51);
   TrigMatched_prong_HLTptfl__4->SetBinContent(17,34);
   TrigMatched_prong_HLTptfl__4->SetBinContent(18,29);
   TrigMatched_prong_HLTptfl__4->SetBinContent(19,14);
   TrigMatched_prong_HLTptfl__4->SetBinContent(20,8);
   TrigMatched_prong_HLTptfl__4->SetBinContent(21,6);
   TrigMatched_prong_HLTptfl__4->SetBinContent(22,6);
   TrigMatched_prong_HLTptfl__4->SetBinContent(23,4);
   TrigMatched_prong_HLTptfl__4->SetBinContent(27,1);
   TrigMatched_prong_HLTptfl__4->SetEntries(30939);
   TrigMatched_prong_HLTptfl__4->SetDirectory(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   TrigMatched_prong_HLTptfl__4->SetLineColor(ci);
   TrigMatched_prong_HLTptfl__4->GetXaxis()->SetRange(1,100);
   TrigMatched_prong_HLTptfl__4->GetXaxis()->SetLabelFont(42);
   TrigMatched_prong_HLTptfl__4->GetXaxis()->SetTitleOffset(1);
   TrigMatched_prong_HLTptfl__4->GetXaxis()->SetTitleFont(42);
   TrigMatched_prong_HLTptfl__4->GetYaxis()->SetLabelFont(42);
   TrigMatched_prong_HLTptfl__4->GetYaxis()->SetTitleFont(42);
   TrigMatched_prong_HLTptfl__4->GetZaxis()->SetLabelFont(42);
   TrigMatched_prong_HLTptfl__4->GetZaxis()->SetTitleOffset(1);
   TrigMatched_prong_HLTptfl__4->GetZaxis()->SetTitleFont(42);
   TrigMatched_prong_HLTptfl__4->Draw("");
   tcanvas1->Modified();
   tcanvas1->cd();
   return TrigMatched_prong_HLTptfl__4;
}


TH1F* TrigMatched_rnn_HLTptfl_PF()
{
//=========Macro generated from canvas: tcanvas1/tcanvas1
//=========  (Mon May 23 04:02:38 2022) by ROOT version 6.26/02
   TCanvas *tcanvas1 = new TCanvas("tcanvas1", "tcanvas1",0,0,4,28);
   tcanvas1->Range(0,0,1,1);
   tcanvas1->SetBorderMode(0);
   tcanvas1->SetBorderSize(0);
   ...
   TH1F *TrigMatched_rnn_HLTptfl__5 = new TH1F("TrigMatched_rnn_HLTptfl__5","TrigMatched_rnn_HLTptfl.TrigMatched_rnn_HLTptfl",100,0,1.08);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(1,13497);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(2,1305);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(3,835);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(4,568);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(5,433);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(6,408);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(7,384);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(8,341);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(9,359);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(10,349);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(11,316);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(12,282);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(13,290);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(14,262);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(15,279);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(16,285);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(17,239);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(18,220);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(19,253);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(20,236);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(21,226);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(22,228);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(23,254);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(24,226);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(25,218);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(26,206);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(27,208);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(28,175);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(29,204);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(30,191);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(31,177);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(32,168);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(33,161);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(34,180);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(35,163);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(36,153);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(37,134);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(38,121);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(39,117);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(40,103);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(41,133);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(42,120);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(43,110);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(44,117);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(45,110);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(46,93);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(47,124);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(48,97);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(49,92);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(50,82);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(51,116);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(52,84);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(53,91);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(54,86);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(55,86);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(56,99);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(57,89);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(58,92);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(59,86);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(60,94);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(61,80);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(62,78);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(63,93);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(64,96);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(65,98);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(66,94);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(67,97);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(68,92);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(69,99);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(70,98);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(71,101);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(72,94);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(73,105);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(74,101);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(75,112);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(76,130);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(77,104);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(78,139);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(79,112);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(80,143);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(81,132);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(82,138);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(83,152);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(84,127);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(85,157);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(86,160);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(87,146);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(88,165);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(89,162);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(90,180);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(91,202);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(92,395);
   TrigMatched_rnn_HLTptfl__5->SetBinContent(93,2);
   TrigMatched_rnn_HLTptfl__5->SetEntries(30939);
   TrigMatched_rnn_HLTptfl__5->SetDirectory(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   TrigMatched_rnn_HLTptfl__5->SetLineColor(ci);
   TrigMatched_rnn_HLTptfl__5->GetXaxis()->SetRange(1,100);
   TrigMatched_rnn_HLTptfl__5->GetXaxis()->SetLabelFont(42);
   TrigMatched_rnn_HLTptfl__5->GetXaxis()->SetTitleOffset(1);
   TrigMatched_rnn_HLTptfl__5->GetXaxis()->SetTitleFont(42);
   TrigMatched_rnn_HLTptfl__5->GetYaxis()->SetLabelFont(42);
   TrigMatched_rnn_HLTptfl__5->GetYaxis()->SetTitleFont(42);
   TrigMatched_rnn_HLTptfl__5->GetZaxis()->SetLabelFont(42);
   TrigMatched_rnn_HLTptfl__5->GetZaxis()->SetTitleOffset(1);
   TrigMatched_rnn_HLTptfl__5->GetZaxis()->SetTitleFont(42);
   TrigMatched_rnn_HLTptfl__5->Draw("");
   tcanvas1->Modified();
   tcanvas1->cd();
   tcanvas1->SetSelected(tcanvas1);
   return TrigMatched_rnn_HLTptfl__5;
}


vector<TH1F*> createHistogram_TrigMatched_Taus_HLTptfl_PF(){
   vector<TH1F*> a;
   a.push_back(TrigMatched_Taus_HLTptfl_Pt_PF());
   a.push_back(TrigMatched_Taus_HLTptfl_Eta_PF());
   a.push_back(TrigMatched_Taus_HLTptfl_Phi_PF());
   a.push_back(TrigMatched_prong_HLTptfl_PF());
   a.push_back(TrigMatched_rnn_HLTptfl_PF());
   return a;
}
...
TCanvas* ratioplot(TH1F* h1, TH1F* h2) {
...
//    h2->SetLineWidth(2);
   ...
   h3->GetYaxis()->SetTitle("ratio Pass/PassFail ");
...
void r22_PassedFailed(){
  ...
  hl_TrigMatched_Taus_HLTptfl_PF = createHistogram_TrigMatched_Taus_HLTptfl_PF();
  ...
  for(int i = 0; i<5; i++){
    two_cut(hs_list, 
    a[i], " Pt_Passed_Failed (Blue) vs. Pt_Passed(Red)",
    hl_TrigMatched_Taus_HLTptfl_PF[i],
    hl_TrigMatched_Taus_HLTptfl[i]);
  }

  std::string pdf_r_s = "ratio_r22_PassFail_vs_Pass.pdf(";
  std::string pdf_r = "ratio_r22_PassFail_vs_Pass.pdf";
  std::string pdf_r_e = "ratio_r22_PassFail_vs_Pass.pdf)";
  
  c1 = ratioplot(hl_TrigMatched_Taus_HLTptfl[0], hl_TrigMatched_Taus_HLTptfl_PF[0]);
  c1->Print(pdf_r_s.c_str(), "pdf");
  for(int i = 1; i< (hs_list.size()-1); i++){
      c1 = ratioplot(hl_TrigMatched_Taus_HLTptfl[i], hl_TrigMatched_Taus_HLTptfl_PF[i]);
      c1->Print(pdf_r.c_str(),"pdf");
  }
  c1 = ratioplot(hl_TrigMatched_Taus_HLTptfl[hs_list.size()-1], hl_TrigMatched_Taus_HLTptfl_PF[hs_list.size()-1]);
  c1->Print(pdf_r_e.c_str(), "pdf");

  TCanvas *c2 = new TCanvas();

  std::string pdf_tau_s = "tau_r22_PassFail_vs_Pass.pdf(";
  std::string pdf_tau = "tau_r22_PassFail_vs_Pass.pdf";
  std::string pdf_tau_e = "tau_r22_PassFail_vs_Pass.pdf)";

  hs_list[0]->Draw("nostack");
  c2->Print(pdf_tau_s.c_str(), "pdf");
  //Draw Histogram Seperately
  for(int i = 0; i< 1;i++){
      hl_TrigMatched_Taus_HLTptfl_PF[i]->Draw();
      c2->Print(pdf_tau.c_str(),"pdf");
      hl_TrigMatched_Taus_HLTptfl[i]->Draw();
      c2->Print(pdf_tau.c_str(),"pdf");
  }
  ...
  c2->Print(pdf_tau.c_str(),"pdf");
  hl_TrigMatched_Taus_HLTptfl_PF[hs_list.size()-1]->Draw();
  c2->Print(pdf_tau.c_str(),"pdf");
  hl_TrigMatched_Taus_HLTptfl[hs_list.size()-1]->Draw();
  c2->Print(pdf_tau_e.c_str(), "pdf");
